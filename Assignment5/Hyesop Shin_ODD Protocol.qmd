...
![](models/snapshots/EXEdenGrowth2_model_display_The_Forest_size_990x1284_cycle_401_time_1663968479751.png){width="300"}

![](models/snapshots/EXEdenGrowth2_model_display_Tree_Types_size_495x642_cycle_401_time_1663968447321.png){width="300"}

no_of_treeA: 6396; no_of_treeB: 4945

Interpret the result.
Did I expect this result? Yes.

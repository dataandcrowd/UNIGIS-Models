...
[The most important design concepts of the model are]{.underline}, Initialisation

## Results

Figure 1 shows the result after the 400th cycle of the simulation. The two seedling types and the spread are clearly noticeable, and there are some signs of competition in between. Figure 2 graphically explains the temporal increase of trees. The increasing trend was very steep in the beginning until the 80th step. This is when the competition and the new germination came into place.

oscillation between the tree types are alike

![Forest Status after Cycle 400. It shows that there a Competition between Tree A (green) and Tree B (Purple)](models/snapshots/EXEdenGrowth2_model_display_The_Forest_size_990x1284_cycle_401_time_1663968479751.png){width="321"}

![A Graphical Representation of Tree types A and B over time](models/snapshots/EXEdenGrowth2_model_display_Tree_Types_size_495x642_cycle_401_time_1663968447321.png){width="300"}
